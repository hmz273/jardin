      ...
      <div className="grid md:grid-cols-2 gap-4 divide-y-2 md:divide-x-2">
        <div>
            <div className="flex space-x-16 pb-4">
                <p className="leading-[28.8px] text-[18px] font-normal">Personnes Max : 6</p>
                <p className="leading-[28.8px] text-[18px] font-normal">Surface : 69m²</p>
            </div>
            <h1 className="text-left mb-4 leading-[46.2px] text-[42px] font-normal tracking-tight text-gray-700 py-8">Appartement Junior</h1>
                <p className="text-left py-4 leading-[28.8px] text-[18px] font-normal">Cet appartement dispose d'un salon, d'une  cuisine entièrement équipée, d'une terrasse privée et de deux salles de  bains dotées d'une douche.</p>
                <p className="text-left py-4 leading-[28.8px] text-[18px] font-normal">Chambre non fumeur</p>
                <p className="text-left py-4 leading-[28.8px] text-[18px] font-normal">1  Grand(s) lit(s) et 2 Lit(s) simple(s) et 1 Canapé-lit</p>
